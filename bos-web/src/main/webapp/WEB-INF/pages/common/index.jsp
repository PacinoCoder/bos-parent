	...
	$(function() {
		...
		$("#btnEp").click(function(){
			...
			if (v) {
				...
				if (v1 == v2) {
					// 两次输入密码一致,发送ajax请求
					$.post("${pageContext.request.contextPath}/userAction_editPassword.action",
						{"password":v1},function(data){
						if (data=='1') {
							//给出提示:修改成功
							$.messager.alert("信息提示","修改成功,请重新登录","info",function(){
								location.href = '${pageContext.request.contextPath }/userAction_logout.action';
							});
						}else{
							//给出提示,发生未知错误,修改失败
							$.messager.alert("错误提示","发生未知错误,修改失败","error");
						}
					});
				}else{
					// 两次输入密码不一致,给出错误提示
            ...
            <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
                <form id="editPasswordForm">
                    ...
                    <tr>
                        ...
                        data-options="validType:'length[4,6]'" required="required"/></td>
                    </tr>
                    <tr>
                        <td>确认密码：</td>
